...
const ContactPage = () => {
  ...
  return (
    <div>
      <section class="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px] p-8 my-12">
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p class="text-body-color mb-9 text-base leading-relaxed">
                       Send a message on our contact form or call us directly for <span className='font-bold'>
                        orders or inquiries
                       </span> . We will get back to you as soon as possible.
              ...
              <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div class="mb-6">
                    <textarea
                      rows="6"
                      placeholder="For orders or inquiries , please describe your request here"
