      ...
      <div className=" w-screen shadow-lg  fixed bg-white  h-20 text-black z-20  mb-4 md:px-8">
        <div className="flex items-center justify-between w-full h-full md:px-8">
          ...
          <div className="hidden md:flex mr-[126px]">
            <a
              href=""
              className=" text-white px-6   bg-blue-600 py-2 rounded hover:bg-blue-700"
              target="_blank"
            >
              Contact Us
            </a>
          ...
          >
            ...
            <div>
              <a
                href=""
                target="_blank"
                className="bg-blue-600 w-full ml-3 rounded-md hover:bg-blue-800 px-4 py-2 text-white"
              >
                Contact Us
              </a>
            </div>
